 ...
 */
public class SharedRDDExample2 {
    /**
    ...
    public static void main(String args[]) {
        ...
        JavaIgniteContext<DataLoader.GeoEntry, String> igniteContext = new JavaIgniteContext<DataLoader.GeoEntry, String>(
                sparkContext,"/s/chopin/b/grad/bbkstha/IdeaProjects/IgniteExamples/config/spark/example-shared-rdd.xml", true);
        ...
        JavaIgniteRDD<DataLoader.GeoEntry, String> stretchRDD = igniteContext.<DataLoader.GeoEntry, String>fromCache("STRETCH-CACHE");

        System.out.println("Cache Name: "+stretchRDD.rdd().cacheName());

        System.out.println("Count is: "+stretchRDD.rdd().count());

        System.out.println("Collect: "+stretchRDD.collect());

        stretchRDD.rdd().clear();
